...
public class Exponenciacao implements IOperacaoMatematica, IImprimir {
    ...
    public Exponenciacao(double num1, double num2, double resutado) {
        this.num1 = num1;
        this.num2 = num2;
    ...
    public double calcular() {
        ...
        entrada.nextLine();
        double numero1 = this.getNum1();
        double numero2 = this.getNum2();
        double resultadoG = (Math.pow(numero1, numero2));
        this.setResutado(resultadoG);
        return resutado;
